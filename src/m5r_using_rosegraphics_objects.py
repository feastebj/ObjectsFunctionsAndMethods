...
#                self.center, self.radius, self.outline_thickness
#
...
#             A Text object is rendered on a window,
...
#            In case the program is an infinite loop and the user wants to
#            disable the program when they want to.
#
